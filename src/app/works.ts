export class Works {
  all = [
    ...
    },
    {
      ...
      desc: "<p>Aplikacja napisana podczas tarnowskiego Hackatonu <a class='link' href='http://www.economicaccelerator.pl/hackathon/'>&#8249;Zaprogramuj_Tarnów&#8250;</a> w przeciągu 36 godzin.</p> <p>Głównym założeniem aplikacji jest <strong>zbieranie danych o stanie parkingów miejskich</strong> w Tarnowie. Na bazie obrazów z kamer miejskich aplikacja proponuje użytkownikowi wolne miejsca parkingowe oraz umożliwia zakup biletów przez <strong>system MoBilet</strong>.</p><p>Aplikacja została napisna jako PWA w Angular 7, komunikując się z API stworzonym w .NET Core.</p><hr/><p>W tworzeniu aplikacji udził wzięli:</p> <ul><li><a class='link-gh' href='https://github.com/jakubfaliszewski'><strong>Jakub Faliszewski</strong> - front-end i grafika</a></li><li><a class='link-gh' href='https://github.com/dawidmalec7'><strong>Dawid Malec</strong> - front-end</a></li><li><a class='link-gh' href='https://github.com/dominikkoziol'><strong>Dominik Kozioł</strong> - back-end</a></li><li><a class='link-gh' href='https://github.com/ksmolenwsei'><strong>Krystian Smoleń</strong> - back-end</a></li>",
      buttons: [{
        type: 'link',
        text: 'kod',
